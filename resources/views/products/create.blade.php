        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <x-card class="mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="e.g. Wireless Bluetooth Barcode Scanner">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="sku" id="skuInput" class="form-control font-monospace @error('sku') is-invalid @enderror" value="{{ old('sku', $suggestedSku) }}" required>
                                <button type="button" class="btn btn-outline-secondary" onclick="generateSku()" title="Generate Unique SKU">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="barcode" id="barcodeInput" class="form-control font-monospace @error('barcode') is-invalid @enderror" value="{{ old('barcode', $suggestedBarcode) }}" placeholder="Scan or generate barcode">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control" rows="3" placeholder="Detailed product specifications, notes, warranty info...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </x-card>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" name="cost_price" id="costPriceInput" class="form-control @error('cost_price') is-invalid @enderror" value="{{ old('cost_price', '0.00') }}" required oninput="calculateMargin()">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light">$</span>
                                <input type="number" step="0.01" min="0" name="selling_price" id="sellingPriceInput" class="form-control @error('selling_price') is-invalid @enderror" value="{{ old('selling_price', '0.00') }}" required oninput="calculateMargin()">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light">$</span>
                                <input type="number" step="0.01" min="0" name="wholesale_price" class="form-control @error('wholesale_price') is-invalid @enderror" value="{{ old('wholesale_price', '0.00') }}">
                            </div>
                            <small class="text-muted">Optional: for bulk buyers</small>
                ...
                <x-card>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Opening Stock Quantity <span class="text-danger">*</span></label>
                            <input type="number" min="0" name="stock_quantity" class="form-control @error('stock_quantity') is-invalid @enderror" value="{{ old('stock_quantity', '0') }}" required>
                            <small class="text-muted">Initial stock on hand</small>
                            @error('stock_quantity') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Minimum / Alert Stock <span class="text-danger">*</span></label>
                            <input type="number" min="0" name="alert_quantity" class="form-control @error('alert_quantity') is-invalid @enderror" value="{{ old('alert_quantity', '10') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="unit" class="form-control @error('unit') is-invalid @enderror" value="{{ old('unit', 'pcs') }}" required placeholder="pcs, kg, box, roll...">
            ...
            <div class="col-lg-4">
                ...
                <x-card class="mb-4">
                    ...
                    <div class="text-center p-3 border rounded-3 bg-light mb-3">
                        <img id="imagePreview" src="{{ asset('images/product-placeholder.svg') }}" alt="Preview" class="img-fluid rounded-3 mb-2" style="max-height: 160px; object-fit: contain;">
                        <div class="small text-muted" id="previewFilename">No image chosen</div>
                    </div>
                ...
                <x-card class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="supplier_id" class="form-select @error('supplier_id') is-invalid @enderror">
                            ...
                            @foreach ($suppliers as $sup)
                                <option value="{{ $sup->id }}" {{ old('supplier_id') == $sup->id ? 'selected' : '' }}>{{ $sup->name }} ({{ $sup->company_name ?? 'Individual' }})</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-check form-switch mt-3 pt-2 border-top">
                        ...
                        <label class="form-check-label fw-semibold" for="createProductActive">Available for sale in POS</label>
                    </div>
                </x-card>
    ...
    async function generateSku() {
        try {
            ...
            if (res.success) {
                ...
                Toast.fire({ icon: 'success', title: 'New SKU Generated: ' + res.sku });
            }
        } catch (e) {
    ...
    async function generateBarcode() {
        try {
            ...
            if (res.success) {
                ...
                Toast.fire({ icon: 'success', title: 'New Barcode Generated: ' + res.barcode });
            }
        } catch (e) {
